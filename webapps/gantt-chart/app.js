...
`;
    ...
    function buildGanttConfig(webAppConfig) {
        ...
        const ganttConfig = {
            ...
            view_mode_select: true,  // Always enabled (#75)
            ...
            today_button: true,  // Always enabled (#75)
    ...
    function renderGantt(tasks, config, isFilterRerender = false) {
        ...
        const ganttOptions = {
            ...
            // Event handlers (read-only mode, no-op)
    ...
    function ensureEdgeToEdgeContent() {
        ...
        if (needsRerender) {
            ...
            if (actualViewMode !== edgeToEdgeExpectedViewMode) {
                return;  // View mode changed during calculation, abort
            }
    ...
    function initTheme() {
        ...
        const themeSetting = persisted || 'light';  // Toolbar dropdown + localStorage only (#75)
