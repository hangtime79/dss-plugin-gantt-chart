...
<!-- All previous learnings have been integrated. This section is now empty. -->

---

## Recently Integrated (2024-12-30)

The following learnings were integrated into cli-docs:

| Learning | Integrated Into |
|----------|-----------------|
| on_view_change mode parameter | `reference/frappe-gantt.md` → "Callbacks" section |
| Position-based date lookup | `reference/frappe-gantt.md` → "Header Manipulation" section |
| PRESET resolution in webapps | `reference/parameters.md` → "PRESET Resolution in Webapps" section |
| DSSPluginPreset.config property | `reference/parameters.md` → "Common Mistake" section |
