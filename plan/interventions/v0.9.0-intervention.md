...
4. `b1a904b` - fix(v0.9.0): Use getElementById for reliable SVG lookup
5. `f09d28e` - fix(v0.9.0): Pill label visibility and UI layout (#47)
6. `cffb374` - docs: Update tracking
7. `8843ec7` - revert(v0.9.0): Disable pills, defer #47 to v0.9.4
...
- #57: Visual stacking order → v0.9.3
...
| #47 Pills | Deferred to v0.9.4 (right-side labels) |
| #57 Markers | Deferred to v0.9.3 |
