...
1. Calculate minimum column width: `minColWidth = currentColWidth × (containerWidth / svgWidth) × 1.02`
...
- ✅ Smooth scrolling in all view modes (main fix)
