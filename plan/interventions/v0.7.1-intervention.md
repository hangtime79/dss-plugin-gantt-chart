...
- ✅ Config panel validation with feedback
- ✅ Smooth scrolling (main fix)

## What's Being Tested (v11)

- Per-view zoom preservation across view switches (fixed: detect rendered width mismatch)
- Zoom floor enforcement per view
- Feedback messages on limits
- Config panel below-floor handling (improved: message after render)
